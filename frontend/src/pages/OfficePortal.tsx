                      ...
                      <TableRow key={booking.id}>
                        ...
                        <TableCell>
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">{booking.senderPhone}</p>
                          </div>
                        </TableCell>
                        <TableCell>
                          <div className="text-sm">
                            <p><strong>From:</strong> {(booking as any).pickupAddress || 'Not specified'}</p>
                            <p><strong>To:</strong> {(booking as any).deliveryAddress || 'Not specified'}</p>
                          </div>
                        </TableCell>
                        <TableCell>
