...
export default function BillPreviewModal({ 
  ...
  const handleDownloadBill = () => {
    try {
      downloadBookingBill(booking, officeName);
      toast({
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6 rounded-lg">
            ...
            <p className="text-blue-100 text-lg mt-1">CARGO BOOKING BILL</p>
            <div className="flex justify-between items-end mt-4">
              <div>
                <p className="text-blue-100">Bill No: <span className="text-white font-semibold">{booking.bookingId || `BK-${booking.id}`}</span></p>
                <p className="text-blue-100">Tracking: <span className="text-white font-semibold">{booking.trackingNumber || 'N/A'}</span></p>
              </div>
              <div className="text-right">
                <p className="text-blue-100">Date: <span className="text-white font-semibold">{formatDate(booking.createdAt)}</span></p>
                <p className="text-blue-100">Type: <span className="text-white font-semibold">{booking.bookingType?.replace('_', ' ').toUpperCase() || 'FTL'}</span></p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-blue-50 p-5 rounded-lg border border-blue-200">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <span className="ml-2 text-gray-700">{booking.vehicleId || 'To be assigned'}</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-4 rounded border">
                ...
                <p className="text-xs text-gray-500 mt-2">
                  For support: support@logigofast.com | +91 7000758030
                </p>
              </div>
            </div>
          </div>
