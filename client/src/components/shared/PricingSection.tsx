...
const plans = [
  ...
  },
  {
    ...
    price: "Connect Team",
    period: "",
    description: "Custom pricing - Connect with our team for personalized quote",
    icon: Crown,
              ...
              <CardContent>
                ...
                {plan.name === "Enterprise" ? (
                  <div className="space-y-3">
                    <Link href="/auth">
                      <Button 
                        className="w-full bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 transform hover:scale-105 transition-all"
                        size="lg"
                      >
                        Start Free Trial
                      </Button>
