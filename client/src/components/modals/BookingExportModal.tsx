...
export default function BookingExportModal({ bookings, trigger }: BookingExportModalProps) {
  ...
  const handleExport = () => {
    ...
    let options: any = {
      officeName: user?.officeName || 'LogiGoFast',
      companyGST: user?.gstNumber || undefined,
      userEmail: user?.email || undefined,
      userName: user?.firstName && user?.lastName 
        ? `${user.firstName} ${user.lastName}` 
        : user?.username || 'LogiGoFast User',
      companyName: user?.officeName || 'LogiGoFast'
    };
    ...
    if (exportType === 'today') {
      ...
      options.startDate = todayStart.toISOString();
      options.endDate = todayEnd.toISOString();
      ...
      options.title = "Custom Date Range Bookings";
    }
