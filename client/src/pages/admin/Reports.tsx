                    ...
                    <div className="flex items-center">
                      ...
                      <div className="flex-1 pl-4">
                        <div className="space-y-3">
                          {(reportsData?.statusDistribution || []).map((item, index) => (
              ...
              <Card className="bg-white/80 backdrop-blur-sm">
                ...
                <CardContent>
                  <div className="space-y-4">
                    {(reportsData?.vehicleDistribution || []).map((vehicle, index) => (
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-3 bg-orange-50 rounded-lg">
                      ...
                      <span className="text-lg font-bold text-orange-900">
                        {(reportsData?.statusDistribution?.find(s => s.type === 'In_transit')?.count || 0)}
                      </span>
                    </div>
                  </div>
                </CardContent>
              ...
              <CardContent>
                <div className="overflow-x-auto">
                  <table className="w-full">
                    ...
                    <tbody>
                      {(reportsData?.topCustomers || []).slice(0, 10).map((customer, index) => (
              ...
              <CardContent>
                <div className="overflow-x-auto">
                  <table className="w-full">
                    ...
                    <tbody>
                      {(reportsData?.topRoutes || []).map((route, index) => (
                        <tr key={index} className="border-b hover:bg-gray-50">
                ...
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
                    <PieChart>
                      ...
                      >
                        {(reportsData?.vehicleDistribution || []).map((entry, index) => (
                          <Cell key={`cell-${index}`} fill={chartColors[index % chartColors.length]} />
                        ))}
                      </Pie>
                      <Tooltip />
