            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-900">
                  ₹{billingDetails?.totalRevenue?.toLocaleString() || 0}
                </p>
              </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-orange-900">
                      ₹{billingDetails?.monthlyBilling?.toLocaleString() || 0}
                    </p>
                  </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">₹{billingDetails.totalRevenue?.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-purple-600">₹{billingDetails.monthlyBilling?.toLocaleString()}</span>
                  </div>
                </div>
              </div>
              <div className="space-y-3">
